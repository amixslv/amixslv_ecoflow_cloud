...
class Delta2TimeTaskMode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    DELTA_2_TIME_TASK_MODE_RESV: _ClassVar[Delta2TimeTaskMode]
    DELTA_2_TIME_TASK_MODE_PER_WEEK: _ClassVar[Delta2TimeTaskMode]
    DELTA_2_TIME_TASK_MODE_ONCE: _ClassVar[Delta2TimeTaskMode]

class Delta2TimeTaskType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    DELTA_2_TIME_TASK_TYPE_AC_CHG: _ClassVar[Delta2TimeTaskType]
    DELTA_2_TIME_TASK_TYPE_AC_DSG: _ClassVar[Delta2TimeTaskType]
    DELTA_2_TIME_TASK_TYPE_AC2_DSG: _ClassVar[Delta2TimeTaskType]
    DELTA_2_TIME_TASK_TYPE_DC_CHG: _ClassVar[Delta2TimeTaskType]
    DELTA_2_TIME_TASK_TYPE_DC2_CHG: _ClassVar[Delta2TimeTaskType]
    DELTA_2_TIME_TASK_TYPE_DC_DSG: _ClassVar[Delta2TimeTaskType]
    DELTA_2_TIME_TASK_TYPE_OIL_ON: _ClassVar[Delta2TimeTaskType]
    DELTA_2_TIME_TASK_TYPE_OIL_OFF: _ClassVar[Delta2TimeTaskType]
    DELTA_2_TIME_TASK_TYPE_USB_CHG: _ClassVar[Delta2TimeTaskType]
    DELTA_2_TIME_TASK_TYPE_USB_DSG: _ClassVar[Delta2TimeTaskType]

class Delta2TimeTaskDetailType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    DELTA_2_TIME_TASK_DETAIL_IDLE: _ClassVar[Delta2TimeTaskDetailType]
    DELTA_2_TIME_TASK_DETAIL_POW: _ClassVar[Delta2TimeTaskDetailType]
    DELTA_2_TIME_TASK_DETAIL_TEMP: _ClassVar[Delta2TimeTaskDetailType]
    DELTA_2_TIME_TASK_DETAIL_LEVEL: _ClassVar[Delta2TimeTaskDetailType]
DELTA_2_TIME_TASK_MODE_RESV: Delta2TimeTaskMode
DELTA_2_TIME_TASK_MODE_PER_WEEK: Delta2TimeTaskMode
DELTA_2_TIME_TASK_MODE_ONCE: Delta2TimeTaskMode
DELTA_2_TIME_TASK_TYPE_AC_CHG: Delta2TimeTaskType
DELTA_2_TIME_TASK_TYPE_AC_DSG: Delta2TimeTaskType
DELTA_2_TIME_TASK_TYPE_AC2_DSG: Delta2TimeTaskType
DELTA_2_TIME_TASK_TYPE_DC_CHG: Delta2TimeTaskType
DELTA_2_TIME_TASK_TYPE_DC2_CHG: Delta2TimeTaskType
DELTA_2_TIME_TASK_TYPE_DC_DSG: Delta2TimeTaskType
DELTA_2_TIME_TASK_TYPE_OIL_ON: Delta2TimeTaskType
DELTA_2_TIME_TASK_TYPE_OIL_OFF: Delta2TimeTaskType
DELTA_2_TIME_TASK_TYPE_USB_CHG: Delta2TimeTaskType
DELTA_2_TIME_TASK_TYPE_USB_DSG: Delta2TimeTaskType
DELTA_2_TIME_TASK_DETAIL_IDLE: Delta2TimeTaskDetailType
DELTA_2_TIME_TASK_DETAIL_POW: Delta2TimeTaskDetailType
DELTA_2_TIME_TASK_DETAIL_TEMP: Delta2TimeTaskDetailType
DELTA_2_TIME_TASK_DETAIL_LEVEL: Delta2TimeTaskDetailType

class Delta2Header(_message.Message):
...
class Delta2SendHeaderMsg(_message.Message):
    __slots__ = ("msg",)
    MSG_FIELD_NUMBER: _ClassVar[int]
    msg: _containers.RepeatedCompositeFieldContainer[Delta2Header]
    def __init__(self, msg: _Optional[_Iterable[_Union[Delta2Header, _Mapping]]] = ...) -> None: ...

class Delta2HeaderMessage(_message.Message):
    __slots__ = ("header",)
    HEADER_FIELD_NUMBER: _ClassVar[int]
    header: _containers.RepeatedCompositeFieldContainer[Delta2Header]
    def __init__(self, header: _Optional[_Iterable[_Union[Delta2Header, _Mapping]]] = ...) -> None: ...

class Delta2TimeTaskParamDetail(_message.Message):
    __slots__ = ("type", "val")
    TYPE_FIELD_NUMBER: _ClassVar[int]
    VAL_FIELD_NUMBER: _ClassVar[int]
    type: Delta2TimeTaskDetailType
    val: float
    def __init__(self, type: _Optional[_Union[Delta2TimeTaskDetailType, str]] = ..., val: _Optional[float] = ...) -> None: ...

class Delta2TimeTaskItemV2(_message.Message):
    ...
    is_enable: bool
    conflict_flag: int
    time_mode: Delta2TimeTaskMode
    time_param: int
    time_table: int
    task_type: Delta2TimeTaskType
    task_param: int
    task_param_detail: _containers.RepeatedCompositeFieldContainer[Delta2TimeTaskParamDetail]
    def __init__(self, task_index: _Optional[int] = ..., is_cfg: _Optional[bool] = ..., is_enable: _Optional[bool] = ..., conflict_flag: _Optional[int] = ..., time_mode: _Optional[_Union[Delta2TimeTaskMode, str]] = ..., time_param: _Optional[int] = ..., time_table: _Optional[int] = ..., task_type: _Optional[_Union[Delta2TimeTaskType, str]] = ..., task_param: _Optional[int] = ..., task_param_detail: _Optional[_Iterable[_Union[Delta2TimeTaskParamDetail, _Mapping]]] = ...) -> None: ...

class Delta2DisplayPropertyUpload(_message.Message):
    ...
    current_time_task_v2_item: Delta2TimeTaskItemV2
    utc_timezone: int
    utc_timezone_id: str
    utc_set_mode: int
    cms_oil_on_soc: int
...
class Delta2SetCommand(_message.Message):
    ...
    cms_max_chg_soc: int
    cms_min_dsg_soc: int
    cfg_energy_backup: Delta2CfgEnergyBackup
    plug_in_info_ac_in_chg_pow_max: int
...
class Delta2CfgEnergyBackup(_message.Message):
...
class Delta2CMSHeartBeatReport(_message.Message):
    __slots__ = ("msg32_2_1", "msg32_2_2")
    MSG32_2_1_FIELD_NUMBER: _ClassVar[int]
    MSG32_2_2_FIELD_NUMBER: _ClassVar[int]
    msg32_2_1: Delta2CMSStatus1
    msg32_2_2: Delta2CMSStatus2
    def __init__(self, msg32_2_1: _Optional[_Union[Delta2CMSStatus1, _Mapping]] = ..., msg32_2_2: _Optional[_Union[Delta2CMSStatus2, _Mapping]] = ...) -> None: ...

class Delta2CMSStatus1(_message.Message):
...
class Delta2CMSStatus2(_message.Message):
...
class Delta2BMSHeartBeatReport(_message.Message):
