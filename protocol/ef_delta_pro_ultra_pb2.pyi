...
class DeltaProUltraTimeTaskMode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    DELTA_PRO_ULTRA_TIME_TASK_MODE_RESV: _ClassVar[DeltaProUltraTimeTaskMode]
    DELTA_PRO_ULTRA_TIME_TASK_MODE_PER_WEEK: _ClassVar[DeltaProUltraTimeTaskMode]
    DELTA_PRO_ULTRA_TIME_TASK_MODE_ONCE: _ClassVar[DeltaProUltraTimeTaskMode]

class DeltaProUltraTimeTaskType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    DELTA_PRO_ULTRA_TIME_TASK_TYPE_AC_CHG: _ClassVar[DeltaProUltraTimeTaskType]
    DELTA_PRO_ULTRA_TIME_TASK_TYPE_AC_DSG: _ClassVar[DeltaProUltraTimeTaskType]
    DELTA_PRO_ULTRA_TIME_TASK_TYPE_AC2_DSG: _ClassVar[DeltaProUltraTimeTaskType]
    DELTA_PRO_ULTRA_TIME_TASK_TYPE_DC_CHG: _ClassVar[DeltaProUltraTimeTaskType]
    DELTA_PRO_ULTRA_TIME_TASK_TYPE_DC2_CHG: _ClassVar[DeltaProUltraTimeTaskType]
    DELTA_PRO_ULTRA_TIME_TASK_TYPE_DC_DSG: _ClassVar[DeltaProUltraTimeTaskType]
    DELTA_PRO_ULTRA_TIME_TASK_TYPE_OIL_ON: _ClassVar[DeltaProUltraTimeTaskType]
    DELTA_PRO_ULTRA_TIME_TASK_TYPE_OIL_OFF: _ClassVar[DeltaProUltraTimeTaskType]
    DELTA_PRO_ULTRA_TIME_TASK_TYPE_USB_CHG: _ClassVar[DeltaProUltraTimeTaskType]
    DELTA_PRO_ULTRA_TIME_TASK_TYPE_USB_DSG: _ClassVar[DeltaProUltraTimeTaskType]

class DeltaProUltraTimeTaskDetailType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    DELTA_PRO_ULTRA_TIME_TASK_DETAIL_IDLE: _ClassVar[DeltaProUltraTimeTaskDetailType]
    DELTA_PRO_ULTRA_TIME_TASK_DETAIL_POW: _ClassVar[DeltaProUltraTimeTaskDetailType]
    DELTA_PRO_ULTRA_TIME_TASK_DETAIL_TEMP: _ClassVar[DeltaProUltraTimeTaskDetailType]
    DELTA_PRO_ULTRA_TIME_TASK_DETAIL_LEVEL: _ClassVar[DeltaProUltraTimeTaskDetailType]
DELTA_PRO_ULTRA_TIME_TASK_MODE_RESV: DeltaProUltraTimeTaskMode
DELTA_PRO_ULTRA_TIME_TASK_MODE_PER_WEEK: DeltaProUltraTimeTaskMode
DELTA_PRO_ULTRA_TIME_TASK_MODE_ONCE: DeltaProUltraTimeTaskMode
DELTA_PRO_ULTRA_TIME_TASK_TYPE_AC_CHG: DeltaProUltraTimeTaskType
DELTA_PRO_ULTRA_TIME_TASK_TYPE_AC_DSG: DeltaProUltraTimeTaskType
DELTA_PRO_ULTRA_TIME_TASK_TYPE_AC2_DSG: DeltaProUltraTimeTaskType
DELTA_PRO_ULTRA_TIME_TASK_TYPE_DC_CHG: DeltaProUltraTimeTaskType
DELTA_PRO_ULTRA_TIME_TASK_TYPE_DC2_CHG: DeltaProUltraTimeTaskType
DELTA_PRO_ULTRA_TIME_TASK_TYPE_DC_DSG: DeltaProUltraTimeTaskType
DELTA_PRO_ULTRA_TIME_TASK_TYPE_OIL_ON: DeltaProUltraTimeTaskType
DELTA_PRO_ULTRA_TIME_TASK_TYPE_OIL_OFF: DeltaProUltraTimeTaskType
DELTA_PRO_ULTRA_TIME_TASK_TYPE_USB_CHG: DeltaProUltraTimeTaskType
DELTA_PRO_ULTRA_TIME_TASK_TYPE_USB_DSG: DeltaProUltraTimeTaskType
DELTA_PRO_ULTRA_TIME_TASK_DETAIL_IDLE: DeltaProUltraTimeTaskDetailType
DELTA_PRO_ULTRA_TIME_TASK_DETAIL_POW: DeltaProUltraTimeTaskDetailType
DELTA_PRO_ULTRA_TIME_TASK_DETAIL_TEMP: DeltaProUltraTimeTaskDetailType
DELTA_PRO_ULTRA_TIME_TASK_DETAIL_LEVEL: DeltaProUltraTimeTaskDetailType

class DeltaProUltraHeader(_message.Message):
...
class DeltaProUltraSendHeaderMsg(_message.Message):
    __slots__ = ("msg",)
    MSG_FIELD_NUMBER: _ClassVar[int]
    msg: _containers.RepeatedCompositeFieldContainer[DeltaProUltraHeader]
    def __init__(self, msg: _Optional[_Iterable[_Union[DeltaProUltraHeader, _Mapping]]] = ...) -> None: ...

class DeltaProUltraHeaderMessage(_message.Message):
    __slots__ = ("header",)
    HEADER_FIELD_NUMBER: _ClassVar[int]
    header: _containers.RepeatedCompositeFieldContainer[DeltaProUltraHeader]
    def __init__(self, header: _Optional[_Iterable[_Union[DeltaProUltraHeader, _Mapping]]] = ...) -> None: ...

class DeltaProUltraTimeTaskParamDetail(_message.Message):
    __slots__ = ("type", "val")
    TYPE_FIELD_NUMBER: _ClassVar[int]
    VAL_FIELD_NUMBER: _ClassVar[int]
    type: DeltaProUltraTimeTaskDetailType
    val: float
    def __init__(self, type: _Optional[_Union[DeltaProUltraTimeTaskDetailType, str]] = ..., val: _Optional[float] = ...) -> None: ...

class DeltaProUltraTimeTaskItemV2(_message.Message):
    ...
    is_enable: bool
    conflict_flag: int
    time_mode: DeltaProUltraTimeTaskMode
    time_param: int
    time_table: int
    task_type: DeltaProUltraTimeTaskType
    task_param: int
    task_param_detail: _containers.RepeatedCompositeFieldContainer[DeltaProUltraTimeTaskParamDetail]
    def __init__(self, task_index: _Optional[int] = ..., is_cfg: _Optional[bool] = ..., is_enable: _Optional[bool] = ..., conflict_flag: _Optional[int] = ..., time_mode: _Optional[_Union[DeltaProUltraTimeTaskMode, str]] = ..., time_param: _Optional[int] = ..., time_table: _Optional[int] = ..., task_type: _Optional[_Union[DeltaProUltraTimeTaskType, str]] = ..., task_param: _Optional[int] = ..., task_param_detail: _Optional[_Iterable[_Union[DeltaProUltraTimeTaskParamDetail, _Mapping]]] = ...) -> None: ...

class DeltaProUltraDisplayPropertyUpload(_message.Message):
    __slots__ = ("errcode", "pow_in_sum_w", "pow_out_sum_w", "energy_backup_en", "energy_backup_start_soc", "pow_get_qcusb1", "pow_get_qcusb2", "pow_get_typec1", "pow_get_typec2", "flow_info_qcusb1", "flow_info_qcusb2", "flow_info_typec1", "flow_info_typec2", "dev_standby_time", "screen_off_time", "ac_standby_time", "ac_always_on_flag", "ac_always_on_mini_soc", "xboost_en", "pcs_fan_level", "flow_info_pv_h", "flow_info_pv_l", "flow_info_24v", "pow_get_pv_h", "pow_get_pv_l", "pow_get_24v", "plug_in_info_pv_h_flag", "plug_in_info_pv_h_type", "plug_in_info_pv_l_flag", "plug_in_info_pv_l_type", "flow_info_12v", "pow_get_12v", "flow_info_ac2dc", "flow_info_dc2ac", "flow_info_ac_in", "pow_get_ac", "pow_get_ac_in", "plug_in_info_ac_in_flag", "plug_in_info_ac_in_feq", "dc_out_open", "cfg_ac_out_open", "pow_get_dcp2", "flow_info_dcp2_in", "flow_info_dcp2_out", "plug_in_info_dcp2_in_flag", "plug_in_info_dcp2_dsg_chg_type", "plug_in_info_dcp2_charger_flag", "plug_in_info_dcp2_type", "plug_in_info_dcp2_detail", "plug_in_info_dcp2_sn", "plug_in_info_dcp2_run_state", "plug_in_info_dcp2_firm_ver", "bms_err_code", "output_power_off_memory", "pv_chg_type", "flow_info_bms_dsg", "flow_info_bms_chg", "pow_get_bms", "flow_info_4p8_1_in", "flow_info_4p8_1_out", "flow_info_4p8_2_in", "flow_info_4p8_2_out", "pow_get_4p8_1", "pow_get_4p8_2", "plug_in_info_4p8_1_in_flag", "plug_in_info_4p8_1_type", "plug_in_info_4p8_1_detail", "plug_in_info_4p8_2_in_flag", "plug_in_info_4p8_2_type", "plug_in_info_4p8_2_detail", "en_beep", "plug_in_info_ac_charger_flag", "plug_in_info_ac_in_chg_pow_max", "ac_out_freq", "dev_sleep_state", "pd_err_code", "mppt_err_code", "llc_hv_lv_flag", "llc_inv_err_code", "plug_in_info_ac_out_dsg_pow_max", "bms_batt_soc", "bms_batt_soh", "bms_design_cap", "bms_dsg_rem_time", "bms_chg_rem_time", "bms_min_cell_temp", "bms_max_cell_temp", "bms_min_mos_temp", "bms_max_mos_temp", "cms_batt_soc", "cms_batt_soh", "cms_dsg_rem_time", "cms_chg_rem_time", "cms_max_chg_soc", "cms_min_dsg_soc", "cms_bms_run_state", "bms_chg_dsg_state", "cms_chg_dsg_state", "time_task_conflict_flag", "time_task_change_cnt", "current_time_task_v2_item", "utc_timezone", "utc_timezone_id", "utc_set_mode", "cms_oil_on_soc", "cms_oil_off_soc", "cms_oil_self_start", "ups_alram", "plug_in_info_pv_dc_amp_max", "led_mode", "low_power_alarm", "silence_chg_watt", "flow_info_pv", "pow_get_pv", "plug_in_info_pv_flag", "plug_in_info_pv_type", "plug_in_info_pv_charger_flag", "plug_in_info_pv_chg_amp_max", "plug_in_info_pv_chg_vol_max", "flow_info_ac_out", "pow_get_ac_out", "flow_info_dcp_in", "flow_info_dcp_out", "pow_get_dcp", "plug_in_info_dcp_in_flag", "plug_in_info_dcp_type", "plug_in_info_dcp_detail", "plug_in_info_dcp_dsg_chg_type", "plug_in_info_dcp_sn", "plug_in_info_dcp_firm_ver", "plug_in_info_dcp_charger_flag", "plug_in_info_dcp_run_state", "plug_in_info_dcp_err_code", "plug_in_info_dcp2_err_code", "plug_in_info_ac_in_chg_hal_pow_max")
    ...
    current_time_task_v2_item: DeltaProUltraTimeTaskItemV2
    utc_timezone: int
    utc_timezone_id: str
    utc_set_mode: int
    cms_oil_on_soc: int
...
class DeltaProUltraSetCommand(_message.Message):
    ...
    cms_max_chg_soc: int
    cms_min_dsg_soc: int
    cfg_energy_backup: DeltaProUltraCfgEnergyBackup
    plug_in_info_ac_in_chg_pow_max: int
...
class DeltaProUltraCfgEnergyBackup(_message.Message):
...
class DeltaProUltraCMSHeartBeatReport(_message.Message):
    __slots__ = ("msg32_2_1", "msg32_2_2")
    MSG32_2_1_FIELD_NUMBER: _ClassVar[int]
    MSG32_2_2_FIELD_NUMBER: _ClassVar[int]
    msg32_2_1: DeltaProUltraCMSStatus1
    msg32_2_2: DeltaProUltraCMSStatus2
    def __init__(self, msg32_2_1: _Optional[_Union[DeltaProUltraCMSStatus1, _Mapping]] = ..., msg32_2_2: _Optional[_Union[DeltaProUltraCMSStatus2, _Mapping]] = ...) -> None: ...

class DeltaProUltraCMSStatus1(_message.Message):
...
class DeltaProUltraCMSStatus2(_message.Message):
...
class DeltaProUltraBMSHeartBeatReport(_message.Message):
