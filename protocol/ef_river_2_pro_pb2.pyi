...
class River2ProTimeTaskMode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    RIVER_2_PRO_TIME_TASK_MODE_RESV: _ClassVar[River2ProTimeTaskMode]
    RIVER_2_PRO_TIME_TASK_MODE_PER_WEEK: _ClassVar[River2ProTimeTaskMode]
    RIVER_2_PRO_TIME_TASK_MODE_ONCE: _ClassVar[River2ProTimeTaskMode]

class River2ProTimeTaskType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    RIVER_2_PRO_TIME_TASK_TYPE_AC_CHG: _ClassVar[River2ProTimeTaskType]
    RIVER_2_PRO_TIME_TASK_TYPE_AC_DSG: _ClassVar[River2ProTimeTaskType]
    RIVER_2_PRO_TIME_TASK_TYPE_AC2_DSG: _ClassVar[River2ProTimeTaskType]
    RIVER_2_PRO_TIME_TASK_TYPE_DC_CHG: _ClassVar[River2ProTimeTaskType]
    RIVER_2_PRO_TIME_TASK_TYPE_DC2_CHG: _ClassVar[River2ProTimeTaskType]
    RIVER_2_PRO_TIME_TASK_TYPE_DC_DSG: _ClassVar[River2ProTimeTaskType]
    RIVER_2_PRO_TIME_TASK_TYPE_OIL_ON: _ClassVar[River2ProTimeTaskType]
    RIVER_2_PRO_TIME_TASK_TYPE_OIL_OFF: _ClassVar[River2ProTimeTaskType]
    RIVER_2_PRO_TIME_TASK_TYPE_USB_CHG: _ClassVar[River2ProTimeTaskType]
    RIVER_2_PRO_TIME_TASK_TYPE_USB_DSG: _ClassVar[River2ProTimeTaskType]

class River2ProTimeTaskDetailType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    RIVER_2_PRO_TIME_TASK_DETAIL_IDLE: _ClassVar[River2ProTimeTaskDetailType]
    RIVER_2_PRO_TIME_TASK_DETAIL_POW: _ClassVar[River2ProTimeTaskDetailType]
    RIVER_2_PRO_TIME_TASK_DETAIL_TEMP: _ClassVar[River2ProTimeTaskDetailType]
    RIVER_2_PRO_TIME_TASK_DETAIL_LEVEL: _ClassVar[River2ProTimeTaskDetailType]
RIVER_2_PRO_TIME_TASK_MODE_RESV: River2ProTimeTaskMode
RIVER_2_PRO_TIME_TASK_MODE_PER_WEEK: River2ProTimeTaskMode
RIVER_2_PRO_TIME_TASK_MODE_ONCE: River2ProTimeTaskMode
RIVER_2_PRO_TIME_TASK_TYPE_AC_CHG: River2ProTimeTaskType
RIVER_2_PRO_TIME_TASK_TYPE_AC_DSG: River2ProTimeTaskType
RIVER_2_PRO_TIME_TASK_TYPE_AC2_DSG: River2ProTimeTaskType
RIVER_2_PRO_TIME_TASK_TYPE_DC_CHG: River2ProTimeTaskType
RIVER_2_PRO_TIME_TASK_TYPE_DC2_CHG: River2ProTimeTaskType
RIVER_2_PRO_TIME_TASK_TYPE_DC_DSG: River2ProTimeTaskType
RIVER_2_PRO_TIME_TASK_TYPE_OIL_ON: River2ProTimeTaskType
RIVER_2_PRO_TIME_TASK_TYPE_OIL_OFF: River2ProTimeTaskType
RIVER_2_PRO_TIME_TASK_TYPE_USB_CHG: River2ProTimeTaskType
RIVER_2_PRO_TIME_TASK_TYPE_USB_DSG: River2ProTimeTaskType
RIVER_2_PRO_TIME_TASK_DETAIL_IDLE: River2ProTimeTaskDetailType
RIVER_2_PRO_TIME_TASK_DETAIL_POW: River2ProTimeTaskDetailType
RIVER_2_PRO_TIME_TASK_DETAIL_TEMP: River2ProTimeTaskDetailType
RIVER_2_PRO_TIME_TASK_DETAIL_LEVEL: River2ProTimeTaskDetailType

class River2ProHeader(_message.Message):
...
class River2ProSendHeaderMsg(_message.Message):
    __slots__ = ("msg",)
    MSG_FIELD_NUMBER: _ClassVar[int]
    msg: _containers.RepeatedCompositeFieldContainer[River2ProHeader]
    def __init__(self, msg: _Optional[_Iterable[_Union[River2ProHeader, _Mapping]]] = ...) -> None: ...

class River2ProHeaderMessage(_message.Message):
    __slots__ = ("header",)
    HEADER_FIELD_NUMBER: _ClassVar[int]
    header: _containers.RepeatedCompositeFieldContainer[River2ProHeader]
    def __init__(self, header: _Optional[_Iterable[_Union[River2ProHeader, _Mapping]]] = ...) -> None: ...

class River2ProTimeTaskParamDetail(_message.Message):
    __slots__ = ("type", "val")
    TYPE_FIELD_NUMBER: _ClassVar[int]
    VAL_FIELD_NUMBER: _ClassVar[int]
    type: River2ProTimeTaskDetailType
    val: float
    def __init__(self, type: _Optional[_Union[River2ProTimeTaskDetailType, str]] = ..., val: _Optional[float] = ...) -> None: ...

class River2ProTimeTaskItemV2(_message.Message):
    ...
    is_enable: bool
    conflict_flag: int
    time_mode: River2ProTimeTaskMode
    time_param: int
    time_table: int
    task_type: River2ProTimeTaskType
    task_param: int
    task_param_detail: _containers.RepeatedCompositeFieldContainer[River2ProTimeTaskParamDetail]
    def __init__(self, task_index: _Optional[int] = ..., is_cfg: _Optional[bool] = ..., is_enable: _Optional[bool] = ..., conflict_flag: _Optional[int] = ..., time_mode: _Optional[_Union[River2ProTimeTaskMode, str]] = ..., time_param: _Optional[int] = ..., time_table: _Optional[int] = ..., task_type: _Optional[_Union[River2ProTimeTaskType, str]] = ..., task_param: _Optional[int] = ..., task_param_detail: _Optional[_Iterable[_Union[River2ProTimeTaskParamDetail, _Mapping]]] = ...) -> None: ...

class River2ProDisplayPropertyUpload(_message.Message):
    ...
    current_time_task_v2_item: River2ProTimeTaskItemV2
    utc_timezone: int
    utc_timezone_id: str
    utc_set_mode: int
    cms_oil_on_soc: int
...
class River2ProSetCommand(_message.Message):
    ...
    cms_max_chg_soc: int
    cms_min_dsg_soc: int
    cfg_energy_backup: River2ProCfgEnergyBackup
    plug_in_info_ac_in_chg_pow_max: int
...
class River2ProCfgEnergyBackup(_message.Message):
...
class River2ProCMSHeartBeatReport(_message.Message):
    __slots__ = ("msg32_2_1", "msg32_2_2")
    MSG32_2_1_FIELD_NUMBER: _ClassVar[int]
    MSG32_2_2_FIELD_NUMBER: _ClassVar[int]
    msg32_2_1: River2ProCMSStatus1
    msg32_2_2: River2ProCMSStatus2
    def __init__(self, msg32_2_1: _Optional[_Union[River2ProCMSStatus1, _Mapping]] = ..., msg32_2_2: _Optional[_Union[River2ProCMSStatus2, _Mapping]] = ...) -> None: ...

class River2ProCMSStatus1(_message.Message):
...
class River2ProCMSStatus2(_message.Message):
...
class River2ProBMSHeartBeatReport(_message.Message):
