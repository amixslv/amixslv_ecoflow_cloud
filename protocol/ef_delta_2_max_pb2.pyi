...
class Delta2MaxTimeTaskMode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    DELTA_2_MAX_TIME_TASK_MODE_RESV: _ClassVar[Delta2MaxTimeTaskMode]
    DELTA_2_MAX_TIME_TASK_MODE_PER_WEEK: _ClassVar[Delta2MaxTimeTaskMode]
    DELTA_2_MAX_TIME_TASK_MODE_ONCE: _ClassVar[Delta2MaxTimeTaskMode]

class Delta2MaxTimeTaskType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    DELTA_2_MAX_TIME_TASK_TYPE_AC_CHG: _ClassVar[Delta2MaxTimeTaskType]
    DELTA_2_MAX_TIME_TASK_TYPE_AC_DSG: _ClassVar[Delta2MaxTimeTaskType]
    DELTA_2_MAX_TIME_TASK_TYPE_AC2_DSG: _ClassVar[Delta2MaxTimeTaskType]
    DELTA_2_MAX_TIME_TASK_TYPE_DC_CHG: _ClassVar[Delta2MaxTimeTaskType]
    DELTA_2_MAX_TIME_TASK_TYPE_DC2_CHG: _ClassVar[Delta2MaxTimeTaskType]
    DELTA_2_MAX_TIME_TASK_TYPE_DC_DSG: _ClassVar[Delta2MaxTimeTaskType]
    DELTA_2_MAX_TIME_TASK_TYPE_OIL_ON: _ClassVar[Delta2MaxTimeTaskType]
    DELTA_2_MAX_TIME_TASK_TYPE_OIL_OFF: _ClassVar[Delta2MaxTimeTaskType]
    DELTA_2_MAX_TIME_TASK_TYPE_USB_CHG: _ClassVar[Delta2MaxTimeTaskType]
    DELTA_2_MAX_TIME_TASK_TYPE_USB_DSG: _ClassVar[Delta2MaxTimeTaskType]

class Delta2MaxTimeTaskDetailType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    DELTA_2_MAX_TIME_TASK_DETAIL_IDLE: _ClassVar[Delta2MaxTimeTaskDetailType]
    DELTA_2_MAX_TIME_TASK_DETAIL_POW: _ClassVar[Delta2MaxTimeTaskDetailType]
    DELTA_2_MAX_TIME_TASK_DETAIL_TEMP: _ClassVar[Delta2MaxTimeTaskDetailType]
    DELTA_2_MAX_TIME_TASK_DETAIL_LEVEL: _ClassVar[Delta2MaxTimeTaskDetailType]
DELTA_2_MAX_TIME_TASK_MODE_RESV: Delta2MaxTimeTaskMode
DELTA_2_MAX_TIME_TASK_MODE_PER_WEEK: Delta2MaxTimeTaskMode
DELTA_2_MAX_TIME_TASK_MODE_ONCE: Delta2MaxTimeTaskMode
DELTA_2_MAX_TIME_TASK_TYPE_AC_CHG: Delta2MaxTimeTaskType
DELTA_2_MAX_TIME_TASK_TYPE_AC_DSG: Delta2MaxTimeTaskType
DELTA_2_MAX_TIME_TASK_TYPE_AC2_DSG: Delta2MaxTimeTaskType
DELTA_2_MAX_TIME_TASK_TYPE_DC_CHG: Delta2MaxTimeTaskType
DELTA_2_MAX_TIME_TASK_TYPE_DC2_CHG: Delta2MaxTimeTaskType
DELTA_2_MAX_TIME_TASK_TYPE_DC_DSG: Delta2MaxTimeTaskType
DELTA_2_MAX_TIME_TASK_TYPE_OIL_ON: Delta2MaxTimeTaskType
DELTA_2_MAX_TIME_TASK_TYPE_OIL_OFF: Delta2MaxTimeTaskType
DELTA_2_MAX_TIME_TASK_TYPE_USB_CHG: Delta2MaxTimeTaskType
DELTA_2_MAX_TIME_TASK_TYPE_USB_DSG: Delta2MaxTimeTaskType
DELTA_2_MAX_TIME_TASK_DETAIL_IDLE: Delta2MaxTimeTaskDetailType
DELTA_2_MAX_TIME_TASK_DETAIL_POW: Delta2MaxTimeTaskDetailType
DELTA_2_MAX_TIME_TASK_DETAIL_TEMP: Delta2MaxTimeTaskDetailType
DELTA_2_MAX_TIME_TASK_DETAIL_LEVEL: Delta2MaxTimeTaskDetailType

class Delta2MaxHeader(_message.Message):
...
class Delta2MaxSendHeaderMsg(_message.Message):
    __slots__ = ("msg",)
    MSG_FIELD_NUMBER: _ClassVar[int]
    msg: _containers.RepeatedCompositeFieldContainer[Delta2MaxHeader]
    def __init__(self, msg: _Optional[_Iterable[_Union[Delta2MaxHeader, _Mapping]]] = ...) -> None: ...

class Delta2MaxHeaderMessage(_message.Message):
    __slots__ = ("header",)
    HEADER_FIELD_NUMBER: _ClassVar[int]
    header: _containers.RepeatedCompositeFieldContainer[Delta2MaxHeader]
    def __init__(self, header: _Optional[_Iterable[_Union[Delta2MaxHeader, _Mapping]]] = ...) -> None: ...

class Delta2MaxTimeTaskParamDetail(_message.Message):
    __slots__ = ("type", "val")
    TYPE_FIELD_NUMBER: _ClassVar[int]
    VAL_FIELD_NUMBER: _ClassVar[int]
    type: Delta2MaxTimeTaskDetailType
    val: float
    def __init__(self, type: _Optional[_Union[Delta2MaxTimeTaskDetailType, str]] = ..., val: _Optional[float] = ...) -> None: ...

class Delta2MaxTimeTaskItemV2(_message.Message):
    ...
    is_enable: bool
    conflict_flag: int
    time_mode: Delta2MaxTimeTaskMode
    time_param: int
    time_table: int
    task_type: Delta2MaxTimeTaskType
    task_param: int
    task_param_detail: _containers.RepeatedCompositeFieldContainer[Delta2MaxTimeTaskParamDetail]
    def __init__(self, task_index: _Optional[int] = ..., is_cfg: _Optional[bool] = ..., is_enable: _Optional[bool] = ..., conflict_flag: _Optional[int] = ..., time_mode: _Optional[_Union[Delta2MaxTimeTaskMode, str]] = ..., time_param: _Optional[int] = ..., time_table: _Optional[int] = ..., task_type: _Optional[_Union[Delta2MaxTimeTaskType, str]] = ..., task_param: _Optional[int] = ..., task_param_detail: _Optional[_Iterable[_Union[Delta2MaxTimeTaskParamDetail, _Mapping]]] = ...) -> None: ...

class Delta2MaxDisplayPropertyUpload(_message.Message):
    ...
    current_time_task_v2_item: Delta2MaxTimeTaskItemV2
    utc_timezone: int
    utc_timezone_id: str
    utc_set_mode: int
    cms_oil_on_soc: int
...
class Delta2MaxSetCommand(_message.Message):
    ...
    cms_max_chg_soc: int
    cms_min_dsg_soc: int
    cfg_energy_backup: Delta2MaxCfgEnergyBackup
    plug_in_info_ac_in_chg_pow_max: int
...
class Delta2MaxCfgEnergyBackup(_message.Message):
...
class Delta2MaxCMSHeartBeatReport(_message.Message):
    __slots__ = ("msg32_2_1", "msg32_2_2")
    MSG32_2_1_FIELD_NUMBER: _ClassVar[int]
    MSG32_2_2_FIELD_NUMBER: _ClassVar[int]
    msg32_2_1: Delta2MaxCMSStatus1
    msg32_2_2: Delta2MaxCMSStatus2
    def __init__(self, msg32_2_1: _Optional[_Union[Delta2MaxCMSStatus1, _Mapping]] = ..., msg32_2_2: _Optional[_Union[Delta2MaxCMSStatus2, _Mapping]] = ...) -> None: ...

class Delta2MaxCMSStatus1(_message.Message):
...
class Delta2MaxCMSStatus2(_message.Message):
...
class Delta2MaxBMSHeartBeatReport(_message.Message):
