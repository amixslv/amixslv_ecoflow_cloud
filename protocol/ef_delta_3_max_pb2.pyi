...
class Delta3MaxTimeTaskMode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    DELTA_3_MAX_TIME_TASK_MODE_RESV: _ClassVar[Delta3MaxTimeTaskMode]
    DELTA_3_MAX_TIME_TASK_MODE_PER_WEEK: _ClassVar[Delta3MaxTimeTaskMode]
    DELTA_3_MAX_TIME_TASK_MODE_ONCE: _ClassVar[Delta3MaxTimeTaskMode]

class Delta3MaxTimeTaskType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    DELTA_3_MAX_TIME_TASK_TYPE_AC_CHG: _ClassVar[Delta3MaxTimeTaskType]
    DELTA_3_MAX_TIME_TASK_TYPE_AC_DSG: _ClassVar[Delta3MaxTimeTaskType]
    DELTA_3_MAX_TIME_TASK_TYPE_AC2_DSG: _ClassVar[Delta3MaxTimeTaskType]
    DELTA_3_MAX_TIME_TASK_TYPE_DC_CHG: _ClassVar[Delta3MaxTimeTaskType]
    DELTA_3_MAX_TIME_TASK_TYPE_DC2_CHG: _ClassVar[Delta3MaxTimeTaskType]
    DELTA_3_MAX_TIME_TASK_TYPE_DC_DSG: _ClassVar[Delta3MaxTimeTaskType]
    DELTA_3_MAX_TIME_TASK_TYPE_OIL_ON: _ClassVar[Delta3MaxTimeTaskType]
    DELTA_3_MAX_TIME_TASK_TYPE_OIL_OFF: _ClassVar[Delta3MaxTimeTaskType]
    DELTA_3_MAX_TIME_TASK_TYPE_USB_CHG: _ClassVar[Delta3MaxTimeTaskType]
    DELTA_3_MAX_TIME_TASK_TYPE_USB_DSG: _ClassVar[Delta3MaxTimeTaskType]

class Delta3MaxTimeTaskDetailType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    DELTA_3_MAX_TIME_TASK_DETAIL_IDLE: _ClassVar[Delta3MaxTimeTaskDetailType]
    DELTA_3_MAX_TIME_TASK_DETAIL_POW: _ClassVar[Delta3MaxTimeTaskDetailType]
    DELTA_3_MAX_TIME_TASK_DETAIL_TEMP: _ClassVar[Delta3MaxTimeTaskDetailType]
    DELTA_3_MAX_TIME_TASK_DETAIL_LEVEL: _ClassVar[Delta3MaxTimeTaskDetailType]
DELTA_3_MAX_TIME_TASK_MODE_RESV: Delta3MaxTimeTaskMode
DELTA_3_MAX_TIME_TASK_MODE_PER_WEEK: Delta3MaxTimeTaskMode
DELTA_3_MAX_TIME_TASK_MODE_ONCE: Delta3MaxTimeTaskMode
DELTA_3_MAX_TIME_TASK_TYPE_AC_CHG: Delta3MaxTimeTaskType
DELTA_3_MAX_TIME_TASK_TYPE_AC_DSG: Delta3MaxTimeTaskType
DELTA_3_MAX_TIME_TASK_TYPE_AC2_DSG: Delta3MaxTimeTaskType
DELTA_3_MAX_TIME_TASK_TYPE_DC_CHG: Delta3MaxTimeTaskType
DELTA_3_MAX_TIME_TASK_TYPE_DC2_CHG: Delta3MaxTimeTaskType
DELTA_3_MAX_TIME_TASK_TYPE_DC_DSG: Delta3MaxTimeTaskType
DELTA_3_MAX_TIME_TASK_TYPE_OIL_ON: Delta3MaxTimeTaskType
DELTA_3_MAX_TIME_TASK_TYPE_OIL_OFF: Delta3MaxTimeTaskType
DELTA_3_MAX_TIME_TASK_TYPE_USB_CHG: Delta3MaxTimeTaskType
DELTA_3_MAX_TIME_TASK_TYPE_USB_DSG: Delta3MaxTimeTaskType
DELTA_3_MAX_TIME_TASK_DETAIL_IDLE: Delta3MaxTimeTaskDetailType
DELTA_3_MAX_TIME_TASK_DETAIL_POW: Delta3MaxTimeTaskDetailType
DELTA_3_MAX_TIME_TASK_DETAIL_TEMP: Delta3MaxTimeTaskDetailType
DELTA_3_MAX_TIME_TASK_DETAIL_LEVEL: Delta3MaxTimeTaskDetailType

class Delta3MaxHeader(_message.Message):
...
class Delta3MaxSendHeaderMsg(_message.Message):
    __slots__ = ("msg",)
    MSG_FIELD_NUMBER: _ClassVar[int]
    msg: _containers.RepeatedCompositeFieldContainer[Delta3MaxHeader]
    def __init__(self, msg: _Optional[_Iterable[_Union[Delta3MaxHeader, _Mapping]]] = ...) -> None: ...

class Delta3MaxHeaderMessage(_message.Message):
    __slots__ = ("header",)
    HEADER_FIELD_NUMBER: _ClassVar[int]
    header: _containers.RepeatedCompositeFieldContainer[Delta3MaxHeader]
    def __init__(self, header: _Optional[_Iterable[_Union[Delta3MaxHeader, _Mapping]]] = ...) -> None: ...

class Delta3MaxTimeTaskParamDetail(_message.Message):
    __slots__ = ("type", "val")
    TYPE_FIELD_NUMBER: _ClassVar[int]
    VAL_FIELD_NUMBER: _ClassVar[int]
    type: Delta3MaxTimeTaskDetailType
    val: float
    def __init__(self, type: _Optional[_Union[Delta3MaxTimeTaskDetailType, str]] = ..., val: _Optional[float] = ...) -> None: ...

class Delta3MaxTimeTaskItemV2(_message.Message):
    ...
    is_enable: bool
    conflict_flag: int
    time_mode: Delta3MaxTimeTaskMode
    time_param: int
    time_table: int
    task_type: Delta3MaxTimeTaskType
    task_param: int
    task_param_detail: _containers.RepeatedCompositeFieldContainer[Delta3MaxTimeTaskParamDetail]
    def __init__(self, task_index: _Optional[int] = ..., is_cfg: _Optional[bool] = ..., is_enable: _Optional[bool] = ..., conflict_flag: _Optional[int] = ..., time_mode: _Optional[_Union[Delta3MaxTimeTaskMode, str]] = ..., time_param: _Optional[int] = ..., time_table: _Optional[int] = ..., task_type: _Optional[_Union[Delta3MaxTimeTaskType, str]] = ..., task_param: _Optional[int] = ..., task_param_detail: _Optional[_Iterable[_Union[Delta3MaxTimeTaskParamDetail, _Mapping]]] = ...) -> None: ...

class Delta3MaxDisplayPropertyUpload(_message.Message):
    ...
    current_time_task_v2_item: Delta3MaxTimeTaskItemV2
    utc_timezone: int
    utc_timezone_id: str
    utc_set_mode: int
    cms_oil_on_soc: int
...
class Delta3MaxSetCommand(_message.Message):
    ...
    cms_max_chg_soc: int
    cms_min_dsg_soc: int
    cfg_energy_backup: Delta3MaxCfgEnergyBackup
    plug_in_info_ac_in_chg_pow_max: int
...
class Delta3MaxCfgEnergyBackup(_message.Message):
...
class Delta3MaxCMSHeartBeatReport(_message.Message):
    __slots__ = ("msg32_2_1", "msg32_2_2")
    MSG32_2_1_FIELD_NUMBER: _ClassVar[int]
    MSG32_2_2_FIELD_NUMBER: _ClassVar[int]
    msg32_2_1: Delta3MaxCMSStatus1
    msg32_2_2: Delta3MaxCMSStatus2
    def __init__(self, msg32_2_1: _Optional[_Union[Delta3MaxCMSStatus1, _Mapping]] = ..., msg32_2_2: _Optional[_Union[Delta3MaxCMSStatus2, _Mapping]] = ...) -> None: ...

class Delta3MaxCMSStatus1(_message.Message):
...
class Delta3MaxCMSStatus2(_message.Message):
...
class Delta3MaxBMSHeartBeatReport(_message.Message):
